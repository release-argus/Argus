...
type ListPageProps = {
	...
	onAdd: () => void;
	/** Blurb rendered under the header. */
	...
	/** Shown when isError. */
	error: unknown;
	/** Shows a spinner in place of the table. */
	isPending?: boolean;
...
export const ListPage = ({
	...
	<>
		...
		{isError ? (
			...
			<output
				aria-label={`Loading ${errorResource}`}
				className="flex min-h-[30vh] w-full items-center justify-center"
			>
