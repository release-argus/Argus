...
import { diffGrants, grantKey } from '@/pages/admin/groups/grant-diff';
...
type GrantEditorProps = {
	...
	/**
	 * The saved group's grants.
	 * When given, rows that differ from it are marked;
	 * omit when creating, where every row is new.
	 */
	savedGrants?: Grant[];
};
