/**
 * Recursively removes empty keys and any key:value's that match the defaults.
 *
 * @param obj - The object to clean.
 * @param defaults - The default values to compare against.
 * @returns A new object with empty keys removed and any key:value's removed that match the defaults.
 */
const cleanEmpty = (
