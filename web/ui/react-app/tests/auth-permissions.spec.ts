...
import type { Action, Grant, Resource } from '@/types/auth';
...
const PERSONAS = [
	...
	{ grants: [grant('metric', 'read')], key: 'metric-read' },
...
const PROBES: Probe[] = [
	...
	// Defaults only needed for create/edit.
	{
		allow: ['service-create', 'service-update'],
		method: 'GET',
		name: 'service defaults',
		ok: 200,
		path: '/api/v1/service/defaults',
	},
	// Resolves env vars, so it is gated on service:update rather than :read.
	{
