...
func TestShoutrrrCheckValues(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"invalid message template": {errRegex: "message: .* <invalid>",
			options: map[string]string{"message": "{{ vesrion }"}},
		"valid message template": {errRegex: "^$",
			options: map[string]string{"message": "{{ vesrion }}"}},
		"invalid title template": {errRegex: "title: .* <invalid>",
			params: map[string]string{"title": "{{ version }"}},
		"valid title template": {errRegex: "^$",
			params: map[string]string{"title": "{{ version }}"}},
		"valid param template": {errRegex: "^$",
			params: map[string]string{"foo": "{{ vesrion }}"}},
		"invalid param template": {errRegex: "foo: .* <invalid>",
			params: map[string]string{"foo": "{{ version }"}},
